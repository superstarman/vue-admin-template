export default {
  ...
  navbar: {
    ...
    switchMode: 'Switch Layout Success',
    profile: 'Profile',
    theme: 'Theme',
    size: 'Global Size',
  },
  login: {
    logoName: 'vue-admin-template',
    title: 'Welcome To Login System',
    logIn: 'Login',
    username: 'Username',
    password: 'Password',
    any: 'any',
    tips: 'Recommended to use IE10 or above, Google...',
    copyright: 'Copyright © Future Co.Ltd',
    capsTips: 'Caps is on',
    errorTips1: 'Please enter the correct account',
    errorTips2: 'Password cannot be less than 6 digits',
    errorTips3: 'Password cannot be more than 20 digits',
  },
  dashboard: {
    ...
    introduce: 'introduce',
    payments: 'Payments',
    conversationRates: 'Conversation Rates',
    oEffect: 'Operational Effect',
    product: 'Product',
    mLatte: 'Matcha Latte',
    milkTea: 'Milk Tea',
    cheeseCocoa: 'Cheese Cocoa',
    wBrownie: 'Walnut Brownie',
    onlineTopSearch: 'Online Top Search',
    date: 'Date',
    rank: 'Rank',
    count: 'Count',
    propOfSales: 'The Proportion Of Sales',
    resource: 'resource',
    item1: 'Item1',
    item2: 'Item2',
    item3: 'Item3',
